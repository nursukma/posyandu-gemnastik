            ...
            <div class="col-12">
                            ...
                            <tbody>
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="text-info fw-bold" href="{{ route('detail-anak', $item->id) }}">
                                                {{ $item->anak_nama }}
                                            </a>
                                        </td>
                                        <td>
                                            {{ $item->anak_lingkar_kepala }}
                                        </td>
                                        <td>
                                            {{ $item->anak_berat_lahir }}
                                        </td>
                                        <td>
                                            {{ $item->anak_tgl_lahir }}
                                        </td>
                                        <td>
                                            {{ $item->anak_tinggi_lahir }}
                                        </td>
                                        <td>
                                            {{ $item->visitor->visitor_nama }}
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-light rounded-pill" title="Ubah"
                                                id='edit' name='edit' data-bs-toggle="modal"
                                                data-bs-target="#editModal"
                                                data-bs-act="{{ route('data-anak.update', $item->id) }}"
                                                data-bs-akta="{{ $item->no_aktaLahir }}"
                                            ...
                                            <button type="button" class="btn btn-light rounded-pill" title="Hapus"
                                                ...
                                                data-bs-act="{{ route('data-anak.destroy', $item->id) }}"
                                                data-bs-nama="{{ $item->anak_nama }}">
                ...
                <div class="modal fade" id="addModal" tabindex="-1">
                    <div class="modal-dialog modal-md modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form class="row g-3 needs-validation" action="{{ route('data-anak.store') }}" method="post"
                                novalidate>
                                @csrf
                ...
                <div class="modal fade" id="editModal" tabindex="-1">
                    <div class="modal-dialog modal-md modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Ubah Data Anak</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                    ...
                    <div class="modal-dialog modal-md modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form class="row g-3 needs-validation" id="delete-form" action="/" method="post"
                                ...
                                <div class="modal-body">
                                    <p class="text-center">
                                        Yakin untuk menghapus data anak dengan nama <strong
